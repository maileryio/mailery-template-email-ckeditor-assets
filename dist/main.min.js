...
this.mailery.template = this.mailery.template || {};
this.mailery.template.email = this.mailery.template.email || {};
this.mailery.template.email.ckeditor = (function (exports) {
	'use strict';
	...
	var ckeditor = createCommonjsModule(function (module, exports) {
	  ...
	  !function (t, e) {
	    ...
	    return function (t) {
	      ...
	      var h = function (t) {
	        return null == t ? void 0 === t ? "[object Undefined]" : "[object Null]" : b && b in Object(t) ? p(t) : y(t);
	      };
	      ...
	      var g = function (t) {
	        return "symbol" == typeof t || m(t) && "[object Symbol]" == h(t);
	      },
	          j = /^\s+|\s+$/g,
	          $ = /^[-+]0x[0-9a-f]+$/i,
	          O = /^0b[01]+$/i,
	      ...
	      var x = function (t) {
	        ...
	        t = t.replace(j, "");
	        var n = O.test(t);
	        return n || _.test(t) ? w(t.slice(2), n ? 2 : 8) : $.test(t) ? NaN : +t;
	      },
	          S = Math.max,
	          E = Math.min;
	      ...
	      var T = function (t, e, n) {
	        ...
	        function b(t) {
	          return l = t, s = setTimeout(m, e), d ? y(t) : c;
	        }

	        function h(t) {
	          var n = t - f;
	          return void 0 === f || n >= e || n < 0 || p && t - l >= a;
	        }
	        ...
	        function m() {
	          ...
	          s = setTimeout(m, function (t) {
	            var n = e - (t - f);
	            return p ? E(n, a - (t - l)) : n;
	          }(t));
	        }

	        function g(t) {
	          return s = void 0, v && r ? y(t) : (r = o = void 0, c);
	        }
	        ...
	        function j() {
	          ...
	          if (r = arguments, o = this, f = t, n) {
	            if (void 0 === s) return b(f);
	            if (p) return clearTimeout(s), s = setTimeout(m, e), y(f);
	          }

	          return void 0 === s && (s = setTimeout(m, e)), c;
	        }

	        return e = x(e) || 0, i(n) && (d = !!n.leading, a = (p = "maxWait" in n) ? S(x(n.maxWait) || 0, e) : a, v = "trailing" in n ? !!n.trailing : v), j.cancel = function () {
	          void 0 !== s && clearTimeout(s), l = 0, r = f = o = s = void 0;
	        }, j.flush = function () {
	          return void 0 === s ? c : g(u());
	        }, j;
	      };
	      ...
	      var D = {
	        ...
	        mounted() {
	          ...
	          this.value && (t.initialData = this.value), this.editor.create(this.$el, t).then(t => {
